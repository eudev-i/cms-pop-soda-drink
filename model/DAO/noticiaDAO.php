    ...
    class NoticiaDAO{
        ...
        public function insertNoticia(Noticia $noticias){
            ...
            $insertSql = "INSERT INTO
                         ...
                         VALUES
                            ('".$noticias->getTitulo()."', '".$noticias->getImagem()."', '".$noticias->getDataNoticia()."', '".$noticias->getDescricao()."', '".$noticia->getStatus()."', '".$noticia->getStatusHome()."' )";
        ...
        public function selectAllNoticias(){
            ...
            while($rsNoticias = $select->fetch(PDO::FETCH_ASSOC)){
                ...
                $noticias[$cont]->setStatusHome($rsNoticias['status_home']);
