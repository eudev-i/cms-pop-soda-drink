...
if (isset($noticias)) {
  ...
  if ($selectStatusHome == 1) {
    $selected_ativado_status_home = "SELECTED";
    $selected_desativado_status_home = "";
  }else {
    $selected_ativado_status_home = "SELECTED";
    $selected_desativado_status_home = "SELECTED";
  }
  ...
  <form id="form" method="POST" enctype="multipart/form-data">
    ...
    <div class="caixa_inputs_evento titulo_e_localidade">
      ...
      <div class="cadastro_necessario">
        ...
        <option <?= @$selected_ativado_status_home ?> value="1"> Ativado </option>

        <option <?= @$selected_desativado_status_home ?> value="0"> Desativado</option>
